...
import LoginSystem from "./components/Modals/LoginSystem";
...
const LoginSuccessModal = lazy(() =>
  import("./components/Modals/LoginSuccessModal")
);
...
function App() {
  ...
  const handleOtpVerified = (token, message) => {
    console.log("Token:", token);
    console.log("Message:", message);
    localStorage.setItem("token", token);

    if (message.toLowerCase().includes("registration")) {
      console.log("Showing CreateAccount modal");
      setShowCreateAccount(true);
    } else {
      console.log("Showing LoginSuccess modal");
          ...
          <Suspense fallback={<LoadingScreen />}>
            <Routes>
              ...
              <Route
                ...
                element={
                  <AgentDetails onLoginClick={() => setShowLoginModal(true)} />
                }
              />
              <Route
                path="/agents/agent-details/:id"
                element={
                  <AgentDetails onLoginClick={() => setShowLoginModal(true)} />
                }
              />
