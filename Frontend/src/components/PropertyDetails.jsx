...
const PropertyDetails = ({ property }) => {
  ...
  const defaultProperty = {
    ...
    detail:
      "Fully furnished with premium interiors. Located on the 10th floor out of 15. Covered parking for 2 cars. 24x7 full backup for uninterrupted power. Freehold property with all legal documents. Corporation and borewell water available 24x7. Gated community with CCTV surveillance.",
    dealer: {
      name: "Avi Patel",
      phone: "+91**83****09",
      email: "*******@gmail.com",
  ...
  return (
    <div className="min-h-screen bg-[#F6F8F9]">
      <div className="container mx-auto px-4 py-6">
        ...
        <button
          onClick={() => {
            ...
            navigate(`/property-listings?${currentParams.toString()}`);
          }}
        ...
        <Card className="bg-[#E8EDF1] flex rounded-2xl shadow-lg overflow-hidden p-4">
          <div className="flex flex-col md:flex-row mb-8">
            ...
            <div className="md:w-1/2 pl-20 pr-20 ">
              <div className="flex flex-row mb-4  mt-6  text-left">
                <div className="border-r pr-4  border-gray-300">
                  <h2 className="text-xl font-bold">
                    {formatPrice(propertyData.priceDetails.expectedPrice)}
                  </h2>
                  <p className="text-sm text-gray-500">
                    {propertyData.priceDetails.pricePerSqFt}/sqft
                  </p>
                </div>
                ...
                <div className="pl-3">
                  <h2 className="text-xl font-bold">{propertyData.flatType}</h2>
                  <p className="text-sm text-gray-500">
              ...
              <div className="text-left mb-4">
                <h1 className="text-2xl font-bold pt-6">
                  {propertyData?.propertyName || propertyData?.name}
                </h1>
                <p className="text-xl text-gray-600 pt-3">
                  {propertyData.additionalDetails
                    ...
                    .slice(0, 8)
                    .join(" ") +
                    (property.additionalDetails.split(" ").length > 20
                      ? " ..."
                      : "")}
                </p>
              </div>
        ...
        <div className="bg-[#F6F8F9] flex rounded-2xl shadow-lg overflow-hidden p-4">
          <div className="bg-[#F6F8F9] p-6 mb-8 md:w-1/2">
            ...
            <div className="flex flex-col md:flex-row justify-between">
              <div className="text-left mb-4 md:mb-3 md:w-2/3 ">
                <p className="text-gray-500 mb-1 font-medium">
                  POSTED BY DEALER:
                </p>
                <p className="font-medium">
                  {propertyData.agentDetails.phoneNumber} |{" "}
                  {propertyData.agentDetails.email}
                </p>
                <p className="text-gray-500 text-xs">
                  {propertyData.agentDetails.name}
                </p>
              </div>
      ...
      <EnquiryModal
        ...
        propertyprice={formatPrice(propertyData.priceDetails.expectedPrice)}
      />
