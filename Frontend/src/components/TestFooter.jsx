    ...
    <footer className="w-full max-w-[1920px]  bg-[#181818] text-gray-300 mx-auto text-left">
      <div className="px-12 py-8 md:px-28  flex flex-col md:flex-row justify-between">
        ...
        <div className="max-w-[400px]">
          <h3 className="text-white font-bold text-lg pl-1.5">Company Info</h3>
          <p className="text-sm mt-3 font-[400] leading-relaxed pl-1.5">
          ...
          <ul>
            <li>
              <div className="flex space-x-3 pt-4 text-left pl-0 pr-0">
                <a
                  href="#"
                  className="text-[#767F8C] text-2xl hover:text-white transition-all duration-300"
                >
                  <FaFacebookF />
                </a>
                <a
