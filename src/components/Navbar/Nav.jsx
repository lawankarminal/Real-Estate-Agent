...
const Nav = ({
  ...
  useEffect(() => {
    const handleScroll = () => {
      const scrollThreshold = document.documentElement.scrollHeight * 0.0;
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center h-16">
          ...
          <div className="flex items-center">
            ...
            <div
              className="flex font-semibold items-center ml-20 text-[#969696]"
            ...
            <div className="flex items-center space-x-20">
              ...
              <div className="relative menu-item">
                <button
                  ref={buyButtonRef}
                  className={`${
                    isScrolled ? "text-[#969696]" : "text-[#969696]"
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span className="ml-2 font-[400] text-[#B0B0B0]">LogIn/Register</span>
            </button>
          </div>
        </div>
      </div>
